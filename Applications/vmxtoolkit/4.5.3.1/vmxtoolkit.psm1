...
function Import-VMXOVATemplate
{
 [CmdletBinding(DefaultParameterSetName='Parameter Set 1',
	...
	if (test-path($OVA))
        ...
        $ovfparam = "--skipManifestCheck --maxVirtualHardwareVersion=14"
        if ($Quiet.IsPresent)
            {
...
function Set-VMXVnet
{
	...
	(
		...
		[Parameter(Mandatory = $true, ValueFromPipelineByPropertyName = $true)][ValidateSet('VMnet1','VMnet2','VMnet3','VMnet4','VMnet5','VMnet6','VMnet7','VMnet8','VMnet9','VMnet10','VMnet11','VMnet12','VMnet13','VMnet14','VMnet15','VMnet16','VMnet17','VMnet18','VMnet19')][Alias('VMnet')]$Vnet
	)
